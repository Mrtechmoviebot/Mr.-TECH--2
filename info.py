...
API_ID = int(environ[''])
API_HASH = environ['']
BOT_TOKEN = environ['6751025808:AAH11oqeOxnziS6QDTK7byZLTwbNpAlynEw']
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002375579069')).split()]
